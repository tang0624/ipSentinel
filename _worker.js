          ...
          <div className="min-h-screen pb-20 px-4 pt-6 md:pt-12 max-w-7xl mx-auto">
            ...
            <footer className="mt-4 text-center text-slate-600 text-sm flex flex-col items-center gap-4">
                 ...
                 <div className="flex items-center gap-4">
                     <a href="https://github.com/tang0624" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-slate-300 transition-colors transform hover:scale-110 duration-300"><Icons.Github className="w-6 h-6" /></a>
                     <a href="https://t.me/Tang0624" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-slate-300 transition-colors transform hover:scale-110 duration-300"><Icons.Telegram className="w-6 h-6" /></a>
                 </div>
            </footer>
          </div>
        );
